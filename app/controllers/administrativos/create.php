...
$password = password_hash($NUE_NUA, PASSWORD_DEFAULT); //El NUA o NUE es la contraseña por default
...
if ($sentencia->execute()) {
    $pdo->commit();
    session_start();
    $_SESSION['mensaje'] = "Se registró el personal administrativo de manera correcta";
    ...
    $pdo->rollBack();
    session_start();
    $_SESSION['mensaje'] = "Error, no se pudo registrar al personal, comuníquese con el administrador";
